...
elseif (isset($params['directoryname']))
{
  ...
  else
  {
    ...
    $editors = empty($params['editors']) || !is_array($params['editors']) ? $userid : implode(';', $params['editors']);
...
else
{
  ...
  {
	$params['editors'] = array($userid);
  }
  if (!is_array($params['editors']))
  {
	$params['editors'] = array($params['editors']);
  }
