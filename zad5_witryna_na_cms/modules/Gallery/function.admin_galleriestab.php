...
//		$onerow->file = $this->CreateLink($id, 'editgallery', $returnid, $gallery['fileid'] == 1 ? 'Gallery/' : $gallery['filename'], array('gid' => $gallery['fileid'], 'mode' => "edit"));
    ...
    if (is_dir(Gallery_utils::DefaultGalleryPath() . $gallery['filepath'] . $gallery['filename']) || $gallery['fileid'] == 1)
    {
...
$smarty->display($this->GetTemplateResource('admingalleries.tpl'));
?>