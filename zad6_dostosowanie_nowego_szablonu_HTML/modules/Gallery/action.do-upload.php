...
$allowed_ext = explode(',', $this->GetPreference('allowed_extensions', ''));
...
$test = '';
  ...
  if (!$chunks || $chunk == $chunks - 1) {
    ...
    else
    {
      ...
      die('{"jsonrpc" : "2.0", "error" : {"code": 9902, "message": "Corrupt file."}, "id" : "id"}');
    }
...
{
	die('{"jsonrpc" : "2.0", "error" : {"code": 9903, "message": "Invalid file"}, "id" : "id"}');
}
